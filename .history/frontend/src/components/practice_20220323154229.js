    ...
    <div className={styles.blackcontents}>
        ...
        <div className={styles.skill}>
            ...
            <div className={styles.content}>
                ...
                <p>フレームワーク：React.js(16.8以降,Redux,React-Router), Next.js, Laravel, express, Vue.js, Nuxt.js, Jest,Node.js, Material-UI, Apollo, PHPUnit, Ajax, Axios, Vuetify, MaterializeCSS,TailwindCSS,
