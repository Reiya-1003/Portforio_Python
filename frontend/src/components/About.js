...
const {ref,inView} = useInView({
    ...
    //  refを与えた要素がウインドウ内に現れるとinViewがtrueになります 
        <div className={styles.whitecontents} ref={ref} id="about">
            {inView && (
            ...
            <div className={styles.contena}>
                 ...
                 <div className={styles.keireki}>
                    ...
                    <div className={styles.second}>
                        <p className={styles.year}>2020/04〜2021/05月</p>　<br></br>
                        <p className={styles.company}>総合リース会社にて営業として従事</p>
                    </div>
                    <div className={styles.second}>
                        <p className={styles.year}>2021/07〜</p><br></br>
                        <p className={styles.company}>ラクスパートナーズ株式会社にてフロントエンドとして転職</p>
                    </div>
                 </div>
            </div>
        </div>
